...
% 指定文件夹路径
if isDualSP == false
    folderPath = 'D:/Documents/Peng/EGG/Datasets/' +  subjno + '/original'; 
else
    folderPath = 'D:/Documents/Peng/EGG/Datasets/' +  subjno + '/dual_start_points';
end
...
% for i = 1:4
    ...
    filepath = fullfile('D:/Documents/Peng/EGG/Datasets', subjno, motion, 'events_info',eventFileName);
    
    disp(filepath)
    eventInfo = cell(len, 3); % 事件信息的储存矩阵
